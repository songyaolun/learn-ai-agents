...
对比 deepagents/ch_03_filesystem.py: 那里 agent 只有 ls/read_file/write_file/edit_file,
...
ch_11_sandbox_backend.py 讲的远程沙箱, 而不是本文件的 LocalShellBackend。
...
# 不会碰到本仓库的真实文件 (跟 ch_04_backend.py 用 tempfile 隔离是同一个思路)。
