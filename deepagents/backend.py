...
对比 deepagents/filesystem.py: 那里用的是 create_deep_agent 的默认 backend
...
(interrupt_on/permissions, 见 deepagents/hitl.py、deepagents/permissions.py),
...
if __name__ == "__main__":
    ...
    # 工具是真的写到了本机文件系统, 而不是像 filesystem.py 里那样只存在于
    ...
    # filesystem.py 里默认的 StateBackend 不一样 (那边写完文件 result["files"]
