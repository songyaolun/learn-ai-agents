...
对比 deepagents/quickstart.py、research.py: 那两个只关心 agent 的最终回答,
...
langchain/middleware_summarization.py)。这里的"文件"默认并不是真实磁盘文件,
...
# deepagents/quickstart.py 里那样自己写 get_weather 这类工具才能演示。
...
if __name__ == "__main__":
    # 跟 quickstart.py 一样用 invoke 拿最终结果; 中间 agent 可能会先调用 write_file
