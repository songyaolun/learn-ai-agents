...
对比 langchain/middleware_hitl.py: 那里要自己 import HumanInTheLoopMiddleware,
...
subagents 里的每个子 agent 也可以单独配 interrupt_on (见 deepagents/quickstart.py 的
...
# interrupt_on 的写法和用法跟 langchain/middleware_hitl.py 里的
