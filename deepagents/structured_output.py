...
对比 langchain/structured_output.py: 那里给普通的 create_agent 传
...
langchain/structured_output.py 里"裸 Pydantic 类不稳定, 要用 ToolStrategy 包一层"
...
# 和 langchain/structured_output.py 一样用 ToolStrategy(ResearchReport) 而不是
...
if __name__ == "__main__":
    ...
    # 给出清楚的提示而不是让程序直接 KeyError 崩溃 (跟 langchain/structured_output.py
    # 里的处理方式保持一致)。
