...
对比 langgraph/ch_01_quickstart.py: ch_01_quickstart.py 走的是 Graph API (StateGraph),
...
对比 ch_14_combo.py 的补充点: ch_14_combo.py 里"跨调用记住状态"靠的是 store (跨 thread 共享),
...
# 对比 ch_01_quickstart.py: 那里用 add_conditional_edges 画分支; 这里直接写 if / for 循环。
# ============================================================
@entrypoint(checkpointer=InMemorySaver())
