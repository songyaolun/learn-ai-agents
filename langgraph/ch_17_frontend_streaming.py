...
对比 langgraph/ch_15_streaming.py 与 langgraph/ch_16_event_streaming.py: 那两个文件讲的是"图怎么产出流"——
ch_15_streaming.py 系统演示 graph.stream() 的四种 stream_mode(values/updates/messages/custom)各自流出
什么结构; ch_16_event_streaming.py 讲 astream_events(v2) 怎么把执行拆成全链路细粒度事件。它们的落点
...
# (结构刻意与 ch_15_streaming.py 保持一致, 便于对照)
# ============================================================
