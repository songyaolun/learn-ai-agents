...
对比 langchain/ch_24_middleware_summarization.py: 那里用 SummarizationMiddleware 压缩单次对话内的短期记忆(消息历史),
...
def main():
    ...
    # 6. 长期记忆 vs 短期记忆边界说明
    print("\n📚 长期记忆 vs 短期记忆边界:")
    print("- 短期记忆: 单线程内的消息历史(如 ch_24_middleware_summarization.py 中的对话记录)")
